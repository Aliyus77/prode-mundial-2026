...
export const useMatches = () => {
  ...
  useEffect(() => {
    ...
    const mockMatches: Match[] = [
      ...
      { id: "3", homeTeam: "Brasil", awayTeam: "Mexico", homeTeamFlag: "🇧🇷", awayTeamFlag: "🇲🇽", group: "B", scheduledDate: new Date(now.getTime() + 7 * 86400000), resultDeadline: new Date(now.getTime() + 7 * 86400000 - 3600000), isFinished: false },
      { id: "4", homeTeam: "Francia", awayTeam: "Canada", homeTeamFlag: "🇫🇷", awayTeamFlag: "🇨🇦", group: "B", scheduledDate: new Date(now.getTime() + 8 * 86400000), resultDeadline: new Date(now.getTime() + 8 * 86400000 - 3600000), isFinished: false },
      { id: "5", homeTeam: "Alemania", awayTeam: "Japon", homeTeamFlag: "🇩🇪", awayTeamFlag: "🇯🇵", group: "C", scheduledDate: new Date(now.getTime() + 9 * 86400000), resultDeadline: new Date(now.getTime() + 9 * 86400000 - 3600000), isFinished: false },
      { id: "6", homeTeam: "Espana", awayTeam: "Costa Rica", homeTeamFlag: "🇪🇸", awayTeamFlag: "🇨🇷", group: "C", scheduledDate: new Date(now.getTime() + 10 * 86400000), resultDeadline: new Date(now.getTime() + 10 * 86400000 - 3600000), isFinished: false },
      { id: "7", homeTeam: "Inglaterra", awayTeam: "Serbia", homeTeamFlag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", awayTeamFlag: "🇷🇸", group: "D", scheduledDate: new Date(now.getTime() + 11 * 86400000), resultDeadline: new Date(now.getTime() + 11 * 86400000 - 3600000), isFinished: false },
      { id: "8", homeTeam: "Paises Bajos", awayTeam: "Italia", homeTeamFlag: "🇳🇱", awayTeamFlag: "🇮🇹", group: "D", scheduledDate: new Date(now.getTime() + 12 * 86400000), resultDeadline: new Date(now.getTime() + 12 * 86400000 - 3600000), isFinished: false },
    ];
  ...
  return (
    <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ width: "100%" }}>
      ...
      <Box sx={{ mt: 2, fontSize: "0.85rem", color: "#666" }}>
        <p>Demo: admin@prode.com / admin123</p>
      </Box>
...
console.log(`\n✅ Complete! ${filesCreated} files created.`);
console.log(`\nNext steps:`);
